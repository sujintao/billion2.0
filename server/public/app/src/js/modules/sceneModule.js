...
var SCENE = (function () {
  ...
  function init() {
    ...
    var currentIndex = 0;
    var previousIndex = 0;
    var clock=[5,7,7,5,7,9,7,7,7,7]; //定时器数组
    var timer=0;
    ...
    function navigation() {
      ...
      timer=setTimeout(navTime,clock[currentIndex]*1000)
      ...
      function touchevent() {
        ...
        function touch(event) {
          ...
          switch (event.type) {
            ...
            case "touchend":
              {
                if (event.changedTouches[0].clientY > touchy) {
                  // next();
                  // prev();
                } else {
                  // prev();
    ...
    function setup() {
      ...
      // console.log(width, resolution, height)
