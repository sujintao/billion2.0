 ...
 * @param {String} [options.font='PingFangSC-Light, sans-serif'] Fonts
...
function TextPanel (text, options) {
  ...
  for (var k = 0; k < wordsCount; k++) {
    ...
    for (var j = 0; j < word.length; j++) {
      context.fillText(word[j], left+k*lineHeight-5, lineHeight*j-5);
      // console.log(left+k*lineHeight,lineHeight*j,canvas.width,canvas.height)  
    }
